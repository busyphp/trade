 ...
 * @version $Id: 2021/11/8 下午6:52 RefundQueryTask.php $
 */
class RefundQueryTask implements TaskWorkerInterface
{
    /**
     * 定时任务间隔毫秒
     * @return int
    ...
    {
        return Service::init()->getTradeConfig('task.refund.query_interval', 1000);
    }
