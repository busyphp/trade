 ...
 * @version $Id: 2021/11/8 下午6:50 RefundSubmitTask.php $
 */
class RefundSubmitTask implements TaskWorkerInterface
{
    /**
     * 定时任务间隔毫秒
     * @return int
    ...
    {
        return Service::init()->getTradeConfig('task.refund.submit_interval', 1000);
    }
